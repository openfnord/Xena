...
/* Creation date Mon Aug 22 13:45:30 EST 2011 */
...
public class ReleaseInfo {
   ...
   /** buildDate (set during build process to 1313984730443L). */
   private static Date buildDate = new Date(1313984730443L);

   /**
    * Get buildDate (set during build process to Mon Aug 22 13:45:30 EST 2011).

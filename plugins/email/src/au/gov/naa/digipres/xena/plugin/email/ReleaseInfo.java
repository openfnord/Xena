...
/* Creation date Mon Aug 22 11:57:56 EST 2011 */
...
public class ReleaseInfo {
   ...
   /** buildDate (set during build process to 1313978276009L). */
   private static Date buildDate = new Date(1313978276009L);

   /**
    * Get buildDate (set during build process to Mon Aug 22 11:57:56 EST 2011).

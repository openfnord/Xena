...
/* Creation date Mon Aug 22 15:18:37 EST 2011 */
...
public class ReleaseInfo {
   ...
   /** buildDate (set during build process to 1313990317436L). */
   private static Date buildDate = new Date(1313990317436L);

   /**
    * Get buildDate (set during build process to Mon Aug 22 15:18:37 EST 2011).

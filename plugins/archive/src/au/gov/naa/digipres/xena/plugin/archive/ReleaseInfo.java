...
/* Creation date Mon Aug 22 13:45:22 EST 2011 */
...
public class ReleaseInfo {
   ...
   /** buildDate (set during build process to 1313984722825L). */
   private static Date buildDate = new Date(1313984722825L);

   /**
    * Get buildDate (set during build process to Mon Aug 22 13:45:22 EST 2011).

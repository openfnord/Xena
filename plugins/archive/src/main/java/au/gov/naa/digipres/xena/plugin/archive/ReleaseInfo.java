...
/* Creation date Fri May 18 15:03:57 EDT 2012 */
...
public class ReleaseInfo {
   ...
   /** buildDate (set during build process to 1337367837922L). */
   private static Date buildDate = new Date(1337367837922L);

   /**
    * Get buildDate (set during build process to Fri May 18 15:03:57 EDT 2012).
   ...
   /** version (set during build process to "1.3.0"). */
   private static String version = new String("1.3.0");

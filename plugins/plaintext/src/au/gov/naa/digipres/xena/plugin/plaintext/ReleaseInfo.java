...
/* Creation date Fri May 18 15:04:34 EDT 2012 */
...
public class ReleaseInfo {
   ...
   /** buildDate (set during build process to 1337367874912L). */
   private static Date buildDate = new Date(1337367874912L);

   /**
    * Get buildDate (set during build process to Fri May 18 15:04:34 EDT 2012).
   ...
   /** version (set during build process to "3.5.0"). */
   private static String version = new String("3.5.0");

   /**
    * Get version (set during build process to "3.5.0").

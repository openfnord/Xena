...
/* Creation date Thu Sep 01 11:39:56 EST 2011 */
...
public class ReleaseInfo {
   ...
   /** buildDate (set during build process to 1314841196652L). */
   private static Date buildDate = new Date(1314841196652L);

   /**
    * Get buildDate (set during build process to Thu Sep 01 11:39:56 EST 2011).

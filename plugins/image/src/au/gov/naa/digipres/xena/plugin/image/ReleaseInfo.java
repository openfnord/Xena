...
/* Creation date Mon Aug 22 13:46:00 EST 2011 */
...
public class ReleaseInfo {
   ...
   /** buildDate (set during build process to 1313984760821L). */
   private static Date buildDate = new Date(1313984760821L);

   /**
    * Get buildDate (set during build process to Mon Aug 22 13:46:00 EST 2011).

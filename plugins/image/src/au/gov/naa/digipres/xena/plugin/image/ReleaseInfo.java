...
/* Creation date Thu Sep 01 12:00:59 EST 2011 */
...
public class ReleaseInfo {
   ...
   /** buildDate (set during build process to 1314842459495L). */
   private static Date buildDate = new Date(1314842459495L);

   /**
    * Get buildDate (set during build process to Thu Sep 01 12:00:59 EST 2011).

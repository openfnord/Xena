...
/* Creation date Mon Aug 22 14:41:57 EST 2011 */
...
public class ReleaseInfo {
   ...
   /** buildDate (set during build process to 1313988117212L). */
   private static Date buildDate = new Date(1313988117212L);

   /**
    * Get buildDate (set during build process to Mon Aug 22 14:41:57 EST 2011).
   ...
   /**
    * Get buildNumber (set during build process to 38).
    * @return int buildNumber
    */
   public static final int getBuildNumber() { return 38; }

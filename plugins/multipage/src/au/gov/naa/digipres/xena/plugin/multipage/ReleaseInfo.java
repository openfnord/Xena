...
/* Creation date Thu Sep 01 11:40:00 EST 2011 */
...
public class ReleaseInfo {
   ...
   /** buildDate (set during build process to 1314841200568L). */
   private static Date buildDate = new Date(1314841200568L);

   /**
    * Get buildDate (set during build process to Thu Sep 01 11:40:00 EST 2011).

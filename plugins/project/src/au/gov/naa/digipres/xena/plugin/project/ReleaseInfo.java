...
/* Creation date Fri May 18 15:04:38 EDT 2012 */
...
public class ReleaseInfo {
   ...
   /** buildDate (set during build process to 1337367878270L). */
   private static Date buildDate = new Date(1337367878270L);

   /**
    * Get buildDate (set during build process to Fri May 18 15:04:38 EDT 2012).

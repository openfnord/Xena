...
/* Creation date Thu Sep 01 14:32:01 EST 2011 */
...
public class ReleaseInfo {
   ...
   /** buildDate (set during build process to 1314851521402L). */
   private static Date buildDate = new Date(1314851521402L);

   /**
    * Get buildDate (set during build process to Thu Sep 01 14:32:01 EST 2011).

...
/* Creation date Mon Aug 22 14:35:33 EST 2011 */
...
public class ReleaseInfo {
   ...
   /** buildDate (set during build process to 1313987733812L). */
   private static Date buildDate = new Date(1313987733812L);

   /**
    * Get buildDate (set during build process to Mon Aug 22 14:35:33 EST 2011).

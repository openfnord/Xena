...
/* Creation date Mon Aug 22 11:58:21 EST 2011 */
...
public class ReleaseInfo {
   ...
   /** buildDate (set during build process to 1313978301329L). */
   private static Date buildDate = new Date(1313978301329L);

   /**
    * Get buildDate (set during build process to Mon Aug 22 11:58:21 EST 2011).

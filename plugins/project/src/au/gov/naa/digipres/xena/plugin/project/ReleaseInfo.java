...
/* Creation date Mon Aug 22 14:42:21 EST 2011 */
...
public class ReleaseInfo {
   ...
   /** buildDate (set during build process to 1313988141649L). */
   private static Date buildDate = new Date(1313988141649L);

   /**
    * Get buildDate (set during build process to Mon Aug 22 14:42:21 EST 2011).

...
public enum ResourceField implements FieldType
{
   ...
   ENTERPRISE_UNIQUE_ID(DataType.STRING),
   ERROR_MESSAGE(DataType.STRING),
   GENERIC(DataType.STRING),
   INACTIVE(DataType.STRING),

...
/* Creation date Mon Aug 22 11:57:53 EST 2011 */
...
public class ReleaseInfo {
   ...
   /** buildDate (set during build process to 1313978273470L). */
   private static Date buildDate = new Date(1313978273470L);

   /**
    * Get buildDate (set during build process to Mon Aug 22 11:57:53 EST 2011).

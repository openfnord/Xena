...
public class OfficeProperties extends PluginProperties {
	...
	public void initialiseProperties() {
		...
		XenaProperty locationProperty =
		    new XenaProperty(OOO_DIR_PROP_NAME, "Base directory of LibreOffice.org installation", XenaProperty.PropertyType.DIR_TYPE, getName()) {

			    /**
			     * Validates that the chosen value for the LibreOffice.org base directory is not null or empty,
		...
		XenaProperty sleepProperty =
		    new XenaProperty(OOO_SLEEP_PROP_NAME, "Sleep time allowed for LibreOffice.org to start (seconds)", XenaProperty.PropertyType.INT_TYPE,
		                     getName()) {

			    /**
			     * Validates that the chosen value for the LibreOffice.org sleep time is a valid number from 0 to 300 (5 minutes)
			     * 
			     * @param newValue
			     * @throws InvalidPropertyException
			     * @throws PropertyMessageException 

...
/* Creation date Mon Aug 22 16:04:06 EST 2011 */
...
public class ReleaseInfo {
   ...
   /** buildDate (set during build process to 1313993046955L). */
   private static Date buildDate = new Date(1313993046955L);

   /**
    * Get buildDate (set during build process to Mon Aug 22 16:04:06 EST 2011).

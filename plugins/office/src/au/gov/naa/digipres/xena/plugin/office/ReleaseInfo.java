...
/* Creation date Thu Sep 01 12:01:15 EST 2011 */
...
public class ReleaseInfo {
   ...
   /** buildDate (set during build process to 1314842475256L). */
   private static Date buildDate = new Date(1314842475256L);

   /**
    * Get buildDate (set during build process to Thu Sep 01 12:01:15 EST 2011).

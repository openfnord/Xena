...
/* Creation date Thu Sep 01 14:31:40 EST 2011 */
...
public class ReleaseInfo {
   ...
   /** buildDate (set during build process to 1314851500263L). */
   private static Date buildDate = new Date(1314851500263L);

   /**
    * Get buildDate (set during build process to Thu Sep 01 14:31:40 EST 2011).

...
/**
 * Type to represent the ODG file type (ODF drawing format in later versions of LibreOffice.org)
 *
 */
public class OdgFileType extends OfficeFileType {
	...
	public String getTextConverterName() {
		throw new IllegalStateException("LibreOffice.org does not have a plain text converter for drawings. "

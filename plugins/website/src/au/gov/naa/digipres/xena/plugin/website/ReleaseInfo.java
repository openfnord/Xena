...
/* Creation date Thu Sep 01 12:01:30 EST 2011 */
...
public class ReleaseInfo {
   ...
   /** buildDate (set during build process to 1314842490021L). */
   private static Date buildDate = new Date(1314842490021L);

   /**
    * Get buildDate (set during build process to Thu Sep 01 12:01:30 EST 2011).
   ...
   /**
    * Get buildNumber (set during build process to 81).
    * @return int buildNumber
    */
   public static final int getBuildNumber() { return 81; }

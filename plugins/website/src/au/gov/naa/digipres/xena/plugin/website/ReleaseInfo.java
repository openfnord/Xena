...
/* Creation date Thu Sep 01 11:40:46 EST 2011 */
...
public class ReleaseInfo {
   ...
   /** buildDate (set during build process to 1314841246944L). */
   private static Date buildDate = new Date(1314841246944L);

   /**
    * Get buildDate (set during build process to Thu Sep 01 11:40:46 EST 2011).
   ...
   /**
    * Get buildNumber (set during build process to 80).
    * @return int buildNumber
    */
   public static final int getBuildNumber() { return 80; }

...
/* Creation date Fri May 18 15:04:39 EDT 2012 */
...
public class ReleaseInfo {
   ...
   /** buildDate (set during build process to 1337367879257L). */
   private static Date buildDate = new Date(1337367879257L);

   /**
    * Get buildDate (set during build process to Fri May 18 15:04:39 EDT 2012).

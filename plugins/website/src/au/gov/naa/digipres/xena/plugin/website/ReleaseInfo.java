...
/* Creation date Mon Aug 22 16:04:21 EST 2011 */
...
public class ReleaseInfo {
   ...
   /** buildDate (set during build process to 1313993061617L). */
   private static Date buildDate = new Date(1313993061617L);

   /**
    * Get buildDate (set during build process to Mon Aug 22 16:04:21 EST 2011).
   ...
   /**
    * Get buildNumber (set during build process to 79).
    * @return int buildNumber
    */
   public static final int getBuildNumber() { return 79; }

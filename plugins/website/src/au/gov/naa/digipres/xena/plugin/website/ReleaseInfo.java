...
/* Creation date Mon Aug 22 15:19:41 EST 2011 */
...
public class ReleaseInfo {
   ...
   /** buildDate (set during build process to 1313990381272L). */
   private static Date buildDate = new Date(1313990381272L);

   /**
    * Get buildDate (set during build process to Mon Aug 22 15:19:41 EST 2011).
   ...
   /**
    * Get buildNumber (set during build process to 78).
    * @return int buildNumber
    */
   public static final int getBuildNumber() { return 78; }

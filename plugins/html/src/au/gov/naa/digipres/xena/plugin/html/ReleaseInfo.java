...
/* Creation date Mon Aug 22 11:57:58 EST 2011 */
...
public class ReleaseInfo {
   ...
   /** buildDate (set during build process to 1313978278921L). */
   private static Date buildDate = new Date(1313978278921L);

   /**
    * Get buildDate (set during build process to Mon Aug 22 11:57:58 EST 2011).

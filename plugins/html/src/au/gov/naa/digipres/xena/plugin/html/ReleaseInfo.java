...
/* Creation date Fri Sep 02 10:35:30 EST 2011 */
...
public class ReleaseInfo {
   ...
   /** buildDate (set during build process to 1314923730470L). */
   private static Date buildDate = new Date(1314923730470L);

   /**
    * Get buildDate (set during build process to Fri Sep 02 10:35:30 EST 2011).
   ...
   /** version (set during build process to "2.5.0"). */
   private static String version = new String("2.5.0");

   /**
    * Get version (set during build process to "2.5.0").

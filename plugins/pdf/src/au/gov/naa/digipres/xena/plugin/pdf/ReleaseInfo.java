...
/* Creation date Fri May 18 15:04:33 EDT 2012 */
...
public class ReleaseInfo {
   ...
   /** buildDate (set during build process to 1337367873927L). */
   private static Date buildDate = new Date(1337367873927L);

   /**
    * Get buildDate (set during build process to Fri May 18 15:04:33 EDT 2012).

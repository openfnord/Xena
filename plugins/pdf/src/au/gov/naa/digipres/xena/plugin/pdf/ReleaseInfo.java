...
/* Creation date Mon Aug 22 14:50:01 EST 2011 */
...
public class ReleaseInfo {
   ...
   /** buildDate (set during build process to 1313988601740L). */
   private static Date buildDate = new Date(1313988601740L);

   /**
    * Get buildDate (set during build process to Mon Aug 22 14:50:01 EST 2011).

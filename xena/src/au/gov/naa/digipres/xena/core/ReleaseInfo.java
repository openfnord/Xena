...
/* Creation date Mon Aug 22 15:09:38 EST 2011 */
...
public class ReleaseInfo {
   ...
   /** buildDate (set during build process to 1313989778520L). */
   private static Date buildDate = new Date(1313989778520L);

   /**
    * Get buildDate (set during build process to Mon Aug 22 15:09:38 EST 2011).

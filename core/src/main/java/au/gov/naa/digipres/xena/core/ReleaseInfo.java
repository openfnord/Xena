...
/* Creation date Fri May 18 15:00:48 EDT 2012 */
...
public class ReleaseInfo {
   ...
   /** buildDate (set during build process to 1337367648676L). */
   private static Date buildDate = new Date(1337367648676L);

   /**
    * Get buildDate (set during build process to Fri May 18 15:00:48 EDT 2012).
   ...
   /** version (set during build process to "6.0.1"). */
   private static String version = new String("6.0.1");

   /**
    * Get version (set during build process to "6.0.1").
